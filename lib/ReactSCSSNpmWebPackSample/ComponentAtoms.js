...
export function createPerformanceTableVisitor(performance, keysToShow) {
    if (performance) {
        ...
        const loadSummary = React.createElement("div", { className: styles.fpsPerformance, style: { paddingLeft: '15px', paddingTop: '30px' } },
...
export function createPerformanceTableSmall(performance, keysToShow, _cacheOnClick) {
    const loadSummary = React.createElement("div", { className: styles.fpsPerformance, style: { paddingLeft: '15px' } },
