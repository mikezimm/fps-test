...
var SourcePages = /** @class */ (function (_super) {
    __extends(SourcePages, _super);
    ...
    SourcePages.prototype.componentDidMount = function () {
    ...
    SourcePages.prototype.componentDidUpdate = function (prevProps) { };
    SourcePages.prototype.render = function () {
        var keysToShow = ['fetch0', 'fetch1', 'fetch2', 'fetch3', 'fetch4', 'fetch5', 'fetch6',];
        var PerformanceElement = createPerformanceTableVisitor(this._performance, keysToShow);
